...
const { writeFile, readFile, unlink } = require('./fsp');
...
class Store {
    ...
    getAll(callback) {
        ...
        fs.readdir(this.rootDir, (err, allFiles) => { //promisify
            ...
            allFiles.forEach(file => {
                ...
                fs.readFile(filePath, 'utf8', (err, contents) => { //promisify as above .get
